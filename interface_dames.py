...
class FenetrePartie(Tk):
    ...
    def __init__(self):
        ...
        # Attribut spécifique pour la position sélectionnée
    ...
    def selectionner(self, event):
        ...
        # TODO: À continuer....
            ...
            if self.demander_positions_deplacement(position, position_destination):
                self.messages['text'] = 'Déplacement réussi.'
            else:
                self.messages['text'] = 'Déplacement non autorisé.'
